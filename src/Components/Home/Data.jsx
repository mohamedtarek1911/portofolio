    ...
    <>
      <div className="home__data">
        ...
        <p className="home__desc">
          3+ years building enterprise dashboards, crypto platforms, and
          real-time UIs with Vue 3, React, and TypeScript — including Arabic RTL
          interfaces.
        </p>
        <div className="home__buttons">
          ...
          download=""
          href={cv}
          className="button button--flex button--light"
        >
          Download CV
          <svg
            className="button__icon"
